...
function preload(){
  ...
  iceimg = loadImage("ice.png");
   ...
   // I made this shape on photoshop
...
function spawnAsteroids(){
  ...
  function spawnSat(){
    if(frameCount%100===0){
      var satelite = createSprite(random(1200, 1300),random(30,570),20,20);
  ...
  function earthmoving(){
   ...
   for (let i=0; i<100; i++)
   {
     translate(0, 0, positions[i][2])
     image(star, positions[i][0],positions[i][1],5,5); 
   }
   pop();
